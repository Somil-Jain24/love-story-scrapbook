    ...
    <div className="min-h-screen p-4 md:p-8">
      ...
      <div className="mt-8 container px-4 mx-auto">
        ...
        <ScrapbookSection title="Our First Conversation" delay={600} id="first-conversation">
          <TypewriterText 
            text="After our first meeting, I couldn't stop thinking about you. Days passed, and finally, I found the courage to start a conversation. Do you remember? Those initial messages, hesitant yet hopeful, each word carefully chosen."
            delay={500}
            className="mb-4 text-romance-softBrown"
          />
